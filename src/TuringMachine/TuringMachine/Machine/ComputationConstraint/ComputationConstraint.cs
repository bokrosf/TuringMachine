...
namespace TuringMachine.Machine.ComputationConstraint
{
    ...
    public abstract class ComputationConstraint<TState, TSymbol>
    {
        ...
        public abstract void Enforce(ComputationState<TState, TSymbol> computationState);
        ...
        protected bool IsComputationFinished(ComputationState<TState, TSymbol> computationState)
        {
